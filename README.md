This project is built using Next.js [Next.js](https://nextjs.org), and it was initialized with the create-next-app CLI tool [`create-next-app`](https://nextjs.org/docs/app/api-reference/cli/create-next-app).
